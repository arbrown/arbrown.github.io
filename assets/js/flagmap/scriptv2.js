...
d3.json("/assets/js/flagmap/us.json", function(unitedState) {
  var data = topojson.feature(unitedState, unitedState.objects.states).features;
  d3.tsv("/assets/js/flagmap/us-state-names-country-area.tsv", function(tsv){
    var info = {};
    ...
    g.append("g")
      ...
      .each(function(d,i){
        if (info[d.id]){
          var flag = new Image();
          flag.src = "/images/flags/" + info[d.id].flag;
          ...
          flag.onload = function(){
            ...
            defs.append("pattern")
              ...
              .append("svg:image")
              .attr("xlink:href", "/images/flags/"+info[d.id].flag)
              .attr("width", flagx)
              .attr("height", flagy)
              .attr("x", 0)
              .attr("y", 0);
    ...
    g.append("g")
      ...
      .on("mousemove", function(d) {
        ...
        html += "</td></tr>";
        html += "<tr><td>";
        html += "<div class='tooltipflag'><img src=/images/flags/" + state.flag + "></div>";
        html += "</td></tr>";
